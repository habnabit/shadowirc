...
(* ⅴ쩢tart ICCAPI.pⅴ� *)
  ...
  function ICCGeneralFindConfigFile(inst : ComponentInstance; searchPrefs : Boolean; canCreate : Boolean; count : integer; folders : ICDirSpecArrayPtr) : ICError;
  {$ifc not GeneratingCFM}
  ...
  function ICCChooseConfig(inst : ComponentInstance) : ICError;
  {$ifc not GeneratingCFM}
    inline $2F3C, 0, 33, $7000, $A82A;
  {$endc}
    (* Requires IC 1.2.
     * It is illegal to call this routine inside a ICBegin/End pair.
  ...
  function ICCChooseNewConfig(inst : ComponentInstance) : ICError;
  {$ifc not GeneratingCFM}
    inline $2F3C, 0, 34, $7000, $A82A;
  {$endc}
    (* Requires IC 1.2.
     * It is illegal to call this routine inside a ICBegin/End pair.
  ...
  function ICCGetConfigName(inst : ComponentInstance; longname : Boolean; var name : Str255) : ICError;
  {$ifc not GeneratingCFM}
    inline $2F3C, 6, 35, $7000, $A82A;
  {$endc}
    (* Requires IC 1.2.
  ...
  function ICCGetConfigReference(inst : ComponentInstance; ref : ICConfigRefHandle) : ICError;
  {$ifc not GeneratingCFM}
  ...
  function ICCSetConfigReference(inst : ComponentInstance; ref : ICConfigRefHandle; flags : longint) : ICError;
  {$ifc not GeneratingCFM}
  ...
  function ICCSpecifyConfigFile(inst : ComponentInstance; var config : FSSpec) : ICError;
  {$ifc not GeneratingCFM}
  ...
  function ICCFindPrefHandle(inst : ComponentInstance; key : Str255; var attr : ICAttr; prefh : Handle) : ICError;
  {$ifc not GeneratingCFM}
    inline $2F3C, 12, 36, $7000, $A82A;
  {$endc}
    (* Requires IC 1.2.
     * You must specify a configuration before calling this routine.
     * If you are getting or setting multiple preferences, you should place
  ...
  function ICCMapEntriesTypeCreator(inst : ComponentInstance; entries : Handle; fType : OSType; fCreator : OSType; filename : Str255; var entry : ICMapEntry) : ICError;
  {$ifc not GeneratingCFM}
    inline $2F3C, 20, 29, $7000, $A82A;
  {$endc}
    (* Requires IC 1.1.
     * You must specify a configuration before calling this routine.
     * You do not have to be inside an ICBegin/End pair to call this routine.
